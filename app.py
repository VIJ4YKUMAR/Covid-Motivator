...
def my_app():
    ...
    if request.method == 'POST':
        try:
            conn = psycopg2.connect("dbname=motivational_quotes_5dft user=vijay password=wuRBKFGrWuC1cDcnWJRxfBYz8yd5J6qI host=dpg-cq2canbv2p9s73eq453g-a")
...
def get_messages():
    ...
    try:
        ...
        rowarray_list = []
        for row in rows:
            t = { 'id': row[0], 'message': row[1], 'name':row[3]}
